...
!(function (e, t) {
          ...
          for (var o = 0; o < t.length; o++) {
            ...
            if (
              (r &&
                !n &&
                (h =
                  'greedy' === r ? '' === t[o].join('').trim() : 1 === t[o].length && 0 === t[o][0].length),
              'greedy' === r && n)
            ) {
              for (var d = [], l = 0; l < u; l++) {
                var c = s ? e[l] : l
      ...
      return (
        this.each(function (e) {
          ...
          for (var t = 0; t < this.files.length; t++)
            u.push({ file: this.files[t], inputElem: this, instanceConfig: d.extend({}, r) })
        }),
        e(),
        this
      )
    ...
    h.call(this, (e = e || {})),
      ...
      (this._nextChunk = function () {
        if (!this._finished) {
          ...
          return (
            t ? ((e = r.substring(0, t)), (r = r.substring(t))) : ((e = r), (r = '')),
            (this._finished = !r),
            this.parseChunk(e)
          )
        }
      ...
      if (
        ...
        var n = (function (e, t, r, i, n) {
          ...
          for (var h = 0; h < n.length; h++) {
            ...
            o = void 0
            for (
              var p = new E({ comments: i, delimiter: f, newline: t, preview: 10 }).parse(e), g = 0;
              g < p.data.length;
              g++
            )
              if (r && y(p.data[g])) c++
  ...
  function E(j) {
    ...
    ;(this.parse = function (i, t, r) {
      ...
      for (
        var w = i.indexOf(M, W), R = i.indexOf(P, W), C = new RegExp(Q(K) + Q(z), 'g'), S = i.indexOf(z, W);
        ;
